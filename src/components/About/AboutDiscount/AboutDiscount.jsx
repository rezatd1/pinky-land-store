      ...
      >
        <div className='wrapper'>
          <div className='discount-info'>
            ...
            <h2>Pinky Land develops its own brands</h2>
            <p>
              The Pinky Lande network is being developed and improved, taking into
            ...
            <p className='discount-info__sm'>
              ...
              and care. Pinky Lande stores offer their customers the widest and
